...
public class RightJoystick : MonoBehaviour, IDragHandler, IPointerUpHandler, IPointerDownHandler
{
    ...
    public virtual void OnDrag(PointerEventData ped)
    {
		...
		if (hero._h.rushfinding) {
			mark.transform.position = hero._h.transform.position + inputVector * hero._h.speed * hero._h.rushlen[hero._h.rushnum];
		}
    }
    ...
    {
        hero._h.rush(new Vector3(inputVector.x, inputVector.y, 0));
